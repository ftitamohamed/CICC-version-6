...
let otpVerify = sessionStorage.getItem('otpVerify')
...
showButton.addEventListener('click',()=>{
    ...
    let verifyBtnState = document.getElementById('verify').style.display;
    if(otpVerify === null){
        return null
    }
    else if ((asideClassList.contains('hide')) && verifyBtnState === 'block'){
    ...
    console.log("this is the verify button ",document.getElementById('verify').style.display)
});
// ============== EVENT LISTENERS ==============
