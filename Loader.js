...
/* <h3>Price per Quantity</h3> */
    ...
    const createCartItem = (order, index) => {
        ...
        const unitPriceWithLogos = order.unit_price || order.price_without_size_color_price || 0;
        console.log(unitPriceWithLogos);
        ...
        <div>
            ...
            <div class="quantity">
                ...
                <div class="quantity-sub">
                    ...
                    <span style="color:light-gray; font-weight:600;"> unit price: ${unitPriceWithLogos} SAR </span>
