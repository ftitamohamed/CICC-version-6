...
/* 
    ...
    CheckoutData = JSON.parse(CheckoutData);
        ...
        const requestBody = {
        cart: {
            orders: [...ordersRequest],// Explicitly define the key "orders"
        },
    ...
    console.log(requestBody);
            ...
            const response = await fetch('https://dashboard.caduksa.com/api/v3/checkout_guest', {
                method: 'POST',
                headers: {
            ...
            console.error(' this is the error of the day Error:', error);
